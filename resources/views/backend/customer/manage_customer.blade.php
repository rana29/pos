                    ...
                    <table id="basic-table" class="data-table table table-striped table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>              
                                    <a href="{{route('customer.edit',$row->id)}}" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i></a>

                                      <a href="{{route('customer.delete',$row->id)}}" id="delete" class="btn btn-success btn-xs "><i class="fa fa-trash"></i></a>
                                </td>
