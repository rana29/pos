                        ...
                        <div class="col-sm-12 col-md-8 col-md-offset-2">
                            ...
                            <div class="panel b-primary bt-md">
                                <div class="panel-content">
                                    <div class="row">
                                        <div class="col-xs-6"><h4 class="text-primary">Daily purchase Report</h4></div>
                                    ...
                                    <div class="row ">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="get" action="{{route('purchase.report.show')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-3 col-sm-9 ">
                                                        <button type="submit" class="btn btn-primary ">Show purchase report</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
