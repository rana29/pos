                        ...
                        <div class="col-sm-12 col-md-8 col-md-offset-2">
                            ...
                            <div class="panel b-primary bt-md">
                                <div class="panel-content">
                                    ...
                                    <div class="row ">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="{{route('catagory.store')}}" enctype="multipart/form-data">
                                                @csrf

                                                <div class="form-group">
                                                    <label for="catagory" class="col-sm-3 control-label">catagory name</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="name" id="catagory" placeholder="Add catagory name" value="{{old('name')}}">
                                                    </div>
                                                </div>
